			...
			case 'delete':
				...
				if ( $this->delete_script( $path ) ) {
					if ( is_file( __FILE__ ) && file_exists( __FILE__ ) )
						...
						$this->add_error( 'replace.io has been successfully removed from your server', 'delete' );
				} else {
	...
	*/
	...
	public function ui() {
		...
		<section class="help">
			...
			<h2 class="red">Replace.io v1.0.0</h2>

			<p>This developer/sysadmin tool carries out replace.io functions on MySQL DBs and can handle serialised PHP Arrays and Objects.</p>
	...
	public function deleted() {
		...
		<section class="row row-branding">
			...
			<h1><a href="http://github.com/bobstermyang/replace.io" target="_blank">Replace.IO<span>/</span><strong>it</strong></a></h1>

			<?php $this->get_errors( 'delete' ); ?>

			<div class="content">
				<p>Thanks for using our replace.io tool! We&rsquo;d really appreciate it if you took a
		...
		<section class="row row-contribute">
			...
			<div class="content">
				...
				<p>Got suggestions? Found a bug? Want to contribute code? <a href="https://github.com/bobstermyang/replace.io">Join us on Github!</a></p>
...
<html class="<?php echo implode( ' ', $classes ); ?>">
	<head>
		...
		<title>replace.io : search replace db</title>
...
;(function($){
	...
	srdb = function() {
		...
		$.extend( t, {
			...
			confirm_strings: {
				live_run: 'Are you absolutely ready to run replace.io? Make sure you have backed up your database!',
